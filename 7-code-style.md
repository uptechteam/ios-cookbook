...
### 0. SwiftLint
We use [SwiftLint](https://github.com/realm/SwiftLint) to enforce Swift style and conventions. Recommended config file [.swiftlint.yml](https://github.com/uptechteam/swiftlint-config/blob/main/.swiftlint.yml).
